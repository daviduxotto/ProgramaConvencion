...
public class FrmAlumnosno extends javax.swing.JFrame {
...
Connection cn = con.conectar();
    ...
    private void initComponents() {
        ...
        BtnInscribir.setForeground(new java.awt.Color(0, 21, 56));
        BtnInscribir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/write.png"))); // NOI18N
        BtnInscribir.setText("Inscribir");
        BtnInscribir.setToolTipText("Inscripcion de Alumno");
        ...
        BtnInscribir.setBounds(30, 70, 110, 40);
...
{   int fila = Tabla.getSelectedRow();
        if(fila != -1){ //vamos a inscribir
           // modelo.removeRow(fila);
            ...
            FrmNuevo nuevo = new FrmNuevo(carne,nombre,Usuario);
   ...
   catch(Exception ex)
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAlumnosno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run()
            {
                     new FrmAlumnosno().setVisible(true);         
            }
        });
    }
    ...
    public void llenartabla()
    {
        ...
        String consulta = "Select Nombre,  Carne from con_alumnos where huella_i_d is null" + filtrado;        
        try
        {
